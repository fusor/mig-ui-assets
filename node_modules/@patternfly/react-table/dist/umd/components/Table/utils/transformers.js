(function (global, factory) {
  ...
  const emptyTD = exports.emptyTD = () => ({
    scope: '',
    component: 'td'
  });

  const scopeColTransformer = exports.scopeColTransformer = () => ({
    scope: 'col'
  });

  const emptyCol = exports.emptyCol = label => _objectSpread({}, label ? {} : {
    scope: ''
  });

  const parentId = exports.parentId = (_value, {
    rowData
  }) => ({
    parentId: rowData.parent
  });

  const mapProps = exports.mapProps = (_label, {
    property,
    rowData
