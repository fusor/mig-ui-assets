...
function mergePropPair() {
  ...
  return _lodashEs.mergeWith.apply(void 0, [(0, _lodashEs.mergeWith)({}, firstProps)].concat(_toConsumableArray(restProps), [function (a, b, key) {
    if (key === 'children') {
