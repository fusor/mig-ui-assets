...
:root {
  ...
  --pf-chart-color-black-100: #d2d2d2;
  --pf-chart-color-black-200: #bbb;
  --pf-chart-color-black-300: #8b8d8f;
  --pf-chart-color-black-400: #72767b;
  --pf-chart-color-black-500: #4d5258;
  ...
  --pf-chart-global--stroke-dash-array: 10, 5;
  ...
  --pf-chart-bullet--threshold-error--Color: #c9190b;
  --pf-chart-bullet--threshold-error--Width: 2;
  --pf-chart-bullet--value--Width: 9;
  --pf-chart-bullet--comparative-measure-line--warning--stroke--Color: #ec7a08;
  --pf-chart-bullet--comparative-measure-line--warning--BorderWidth: 1;
  --pf-chart-bullet--comparative-measure-line--error--stroke--Color: #c9190b;
  --pf-chart-bullet--comparative-measure-line--error--BorderWidth: 1;
  --pf-chart-bullet--zero-line--stroke--Color: #4d5258;
  --pf-chart-bullet--zero-line--BorderWidth: 1;
  --pf-chart-bullet--negative-primary-measure--stroke--Color: #c9190b;
  --pf-chart-bullet--negative-primary-measure--BorderWidth: 2;
  ...
  --pf-chart-chart--BorderWidth: 1 solid;
  ...
  --pf-chart-donut--threshold--success--Color: #06c;
  ...
  --pf-chart-donut--utilization--label--subtitle--Fill: #bbb;
  --pf-chart-donut--utilization--label--orientation: vertical;
  ...
  --pf-chart-pie--angle--Padding: 1;
  --pf-chart-pie--Height: 230;
  --pf-chart-pie--Width: 230;
  --pf-chart-pie--small--Height: 150;
  --pf-chart-pie--small--Width: 150;
  ...
  --pf-chart-tooltip--flyoutStyle--Fill: #ededed;
  --pf-chart-tooltip--pointer--Height: 10;
  --pf-chart-tooltip--pointer--Width: 20;
  --pf-chart-tooltip--Padding: 16;
  --pf-chart-tooltip--PointerEvents: none;
  --pf-chart-tooltip--labels--Padding: 5;
  --pf-chart-tooltip--labels--PointerEvents: none;
  ...
  --pf-chart-voronoi--flyout--stroke--Fill: #ededed;
  --pf-chart-voronoi--flyout--PointerEvents: none; }
