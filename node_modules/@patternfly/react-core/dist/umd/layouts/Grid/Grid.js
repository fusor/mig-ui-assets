(function (global, factory) {
  if (typeof define === "function" && define.amd) {
    define(["exports", "react", "prop-types", "@patternfly/react-styles/css/layouts/Grid/grid", "@patternfly/react-styles", "../../styles/gutters", "./gridUtils", "../../styles/sizes"], factory);
  } else if (typeof exports !== "undefined") {
    factory(exports, require("react"), require("prop-types"), require("@patternfly/react-styles/css/layouts/Grid/grid"), require("@patternfly/react-styles"), require("../../styles/gutters"), require("./gridUtils"), require("../../styles/sizes"));
  } else {
    var mod = {
      exports: {}
    };
    factory(mod.exports, global.react, global.propTypes, global.grid, global.reactStyles, global.gutters, global.gridUtils, global.sizes);
    global.undefined = mod.exports;
  }
})(this, function (exports, _react, _propTypes, _grid, _reactStyles, _gutters, _gridUtils, _sizes) {
  "use strict";
  ...
  const gridItemSpanValueShape = _propTypes2.default.oneOf(_gridUtils.gridSpans);
  ...
  const Grid = _ref => {
    ...
    const classes = [_grid2.default.grid, span && (0, _gridUtils.getGridSpanModifier)(span)];
    ...
    return _react2.default.createElement("div", _extends({
      className: (0, _reactStyles.css)(...classes, gutter && (0, _gutters.getGutterModifier)(_grid2.default, gutter, _grid2.default.modifiers && _grid2.default.modifiers.gutter), className)
    }, props), children);
  };
