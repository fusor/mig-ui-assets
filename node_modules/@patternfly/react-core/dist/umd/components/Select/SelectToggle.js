    ...
    render() {
      const _this$props = this.props,
        ...
        ariaLabelToggle
            ...
            props = _objectWithoutProperties(_this$props, ["className", "children", "isExpanded", "isFocused", "isActive", "isHovered", "isPlain", "variant", "onToggle", "onEnter", "onClose", "handleTypeaheadKeys", "parentRef", "id", "type", "ariaLabelledBy", "ariaLabelToggle"]);
      ...
      return React.createElement(React.Fragment, null, !isTypeahead && React.createElement("button", _extends({}, props, toggleProps, {
        ref: this.toggle,
        type: type,
        className: (0, _reactStyles.css)(_select2.default.selectToggle, isFocused && _select2.default.modifiers.focus, isHovered && _select2.default.modifiers.hover, isActive && _select2.default.modifiers.active, isPlain && _select2.default.modifiers.plain, className),
        onClick: _event => {
          onToggle(!isExpanded);
        ...
        ref: this.toggle,
        className: (0, _reactStyles.css)(_select2.default.selectToggle, isFocused && _select2.default.modifiers.focus, isHovered && _select2.default.modifiers.hover, isActive && _select2.default.modifiers.active, isPlain && _select2.default.modifiers.plain, isTypeahead && _select2.default.modifiers.typeahead, className),
        onClick: _event => {
          onToggle(true);
        },
        onKeyDown: this.onKeyDown
