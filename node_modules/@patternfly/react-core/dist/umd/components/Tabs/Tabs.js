(function (global, factory) {
  if (typeof define === "function" && define.amd) {
    define(["exports", "prop-types", "react", "@patternfly/react-styles/css/components/Tabs/tabs", "@patternfly/react-styles/css/components/Button/button", "@patternfly/react-styles", "@patternfly/react-icons", "../../helpers/util", "../../helpers/constants", "./TabContent", "./Tab", "../withOuia"], factory);
  } else if (typeof exports !== "undefined") {
    factory(exports, require("prop-types"), require("react"), require("@patternfly/react-styles/css/components/Tabs/tabs"), require("@patternfly/react-styles/css/components/Button/button"), require("@patternfly/react-styles"), require("@patternfly/react-icons"), require("../../helpers/util"), require("../../helpers/constants"), require("./TabContent"), require("./Tab"), require("../withOuia"));
  } else {
    var mod = {
      exports: {}
    };
    factory(mod.exports, global.propTypes, global.react, global.tabs, global.button, global.reactStyles, global.reactIcons, global.util, global.constants, global.TabContent, global.Tab, global.withOuia);
    global.undefined = mod.exports;
  }
})(this, function (exports, _propTypes, _react, _tabs, _button, _reactStyles, _reactIcons, _util, _constants, _TabContent, _Tab, _withOuia) {
  "use strict";
    ...
    render() {
      const _this$props = this.props,
        ...
        ouiaId
            ...
            props = _objectWithoutProperties(_this$props, ["className", "children", "activeKey", "id", "isFilled", "isSecondary", "leftScrollAriaLabel", "rightScrollAriaLabel", "aria-label", "variant", "ouiaContext", "ouiaId"]);
      ...
      return React.createElement(React.Fragment, null, React.createElement(Component, _extends({
        ...
        key: index,
        className: (0, _reactStyles.css)(_tabs2.default.tabsItem, child.props.eventKey === activeKey && _tabs2.default.modifiers.current, className)
      ...
      }, React.createElement(_reactIcons.AngleRightIcon, null))), React.Children.map(children, (child, index) => !child.props.children ? null : React.createElement(_TabContent.TabContent, {
        key: index,
        activeKey: activeKey,
        child: child,
