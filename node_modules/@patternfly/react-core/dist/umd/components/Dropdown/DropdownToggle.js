  ...
  const DropdownToggle = exports.DropdownToggle = _ref => {
    let {
      ...
      ref
        ...
        props = _objectWithoutProperties(_ref, ["id", "children", "className", "isOpen", "parentRef", "isFocused", "isHovered", "isActive", "isDisabled", "isPlain", "onToggle", "iconComponent", "splitButtonItems", "ariaHasPopup", "ref"]);
