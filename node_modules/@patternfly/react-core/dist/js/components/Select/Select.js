  ...
  _createClass(Select, [{
    ...
    value: function extendTypeaheadChildren(typeaheadActiveChild) {
      ...
      return this.state.typeaheadFilteredChildren.map(function (child) {
        return React.cloneElement(child, {
          isFocused: typeaheadActiveChild && typeaheadActiveChild.innerText === _this2.getDisplay(child.props.value.toString(), 'text')
        });
      });
    }
  }, {
    ...
    value: function render() {
      ...
      var _this$props2 = this.props,
          ...
          props = _objectWithoutProperties(_this$props2, ["children", "className", "variant", "direction", "onToggle", "onSelect", "onClear", "onFilter", "toggleId", "isExpanded", "isGrouped", "isPlain", "isDisabled", "selections", "ariaLabelledBy", "ariaLabelTypeAhead", "ariaLabelClear", "ariaLabelToggle", "ariaLabelRemove", "aria-label", "placeholderText", "width", "toggleIcon"]);
...
_defineProperty(Select, "propTypes", {
  ...
  toggleIcon: _propTypes["default"].element
});
