...
export class SelectMenu extends React.Component {
  ...
  render() {
    ...
    return React.createElement(SelectConsumer, null, ({
      ...
      role: "listbox"
    }), this.extendChildren()), variant === SelectVariant.checkbox && React.createElement(FocusTrap, {
      focusTrapOptions: {
...
_defineProperty(SelectMenu, "propTypes", {
  ...
  isExpanded: _pt.bool,
  isGrouped: _pt.bool,
  selected: _pt.oneOfType([_pt.string, _pt.arrayOf(_pt.string)]),
  checked: _pt.arrayOf(_pt.string),
